...
#flugels
sf1a = p.LpVariable('sf1a', lowBound=0) 
sf2a = p.LpVariable('sf2a', lowBound=0) 
sf3a = p.LpVariable('sf3a', lowBound=0) 
sf4a = p.LpVariable('sf4a', lowBound=0) 
sf5a = p.LpVariable('sf5a', lowBound=0) 

sf1b = p.LpVariable('sf1b', lowBound=0) 
sf2b = p.LpVariable('sf2b', lowBound=0) 
sf3b = p.LpVariable('sf3b', lowBound=0) 
sf4b = p.LpVariable('sf4b', lowBound=0) 
sf5b = p.LpVariable('sf5b', lowBound=0) 
...
- (7.5*sw1a + 7.8*sw1b + 7.5*sw2a + 7.8*sw2b + 7.5*sw3a + 7.8*sw3b + 7.5*sw4a + 7.8*sw4b + 7.5*sw5a + 7.8*sw5b + 5.5*sg1a + 5.7*sg1b + 5.5*sg2a + 5.5*sg2b + 5.7*sg3a + 5.5*sw3b + 5.7*sw4a + 5.5*sw4b + 5.7*sw5a + 5.5*sw5b + 6.5*sf1a + 7*sf1b + 6.5*sf2a + 7*sf2b + 6.5*sf3a + 7*sf3b + 6.5*sf4a + 7*sf4b + 6.5*sf5a + 7*sf4b)
